...
class PolygonModifiedTest {
    ...
    String pointsString = "273 582, 579 555, 639 353, 854 473, 946 319, 825 297, 809 155";
    //, 958 148, 958 72, 743 76, 743 202, 538 247, 475 108, 240 128, 243 364, 168 420, 109 479, 200 628, 451 666, 273 582
    Point point;
    @EqualsAndHashCode.Include
    List<Vertex> vertices;
    private List<Vertex> createVertecies(String pointsString) {
    ...
    @BeforeEach
    void setUp() {
        point = new Point(new SimpleDoubleProperty(825), new SimpleDoubleProperty(297));
        vertices = createVertecies(pointsString);
